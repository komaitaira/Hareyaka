Company.create!(
  [ 
    ...
    {
      id: 14,
      company_name: "ゲストカンパニー",
      kana_company_name: "ゲストカンパニー",
      postal_code: "7654321",
      address: "東京都港区765-76-5",
      phone_number: "10987654321",
      email: "guestcompany@example.com",
      password: SecureRandom.urlsafe_base64,
      introduction: "ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
                    ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
                    ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
                    ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
                    ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
                    ご相談がある方、お悩みがある方、気軽にご連絡ください！ご相談がある方、お悩みがある方、気軽にご連絡ください！
